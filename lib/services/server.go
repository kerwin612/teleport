...
func NewAWSNodeFromEC2Instance(instance ec2Types.Instance, awsCloudMetadata *types.AWSInfo) (types.Server, error) {
	...
	if instance.Placement == nil {
		return nil, trace.BadParameter("ec2 instance placement not present")
	}
	awsCloudMetadata.InstanceID = aws.ToString(instance.InstanceId)
	awsCloudMetadata.AvailabilityZone = aws.ToString(instance.Placement.AvailabilityZone)
	...
	server, err := types.NewNode(
		types.SubKindOpenSSHEphemeralKeyNode,
		types.ServerSpecV2{
